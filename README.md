...
| --- | --- | --- | --- | --- |
| Loops | `loops` | [![skills.sh](https://skills.sh/b/wundercorp/loops-skill)](https://skills.sh/wundercorp/loops-skill) | [loops-skill](https://github.com/wundercorp/loops-skill) | `skill-repositories/loops-skill` |
...
| Isaac | `isaac` | [![skills.sh](https://skills.sh/b/wundercorp/isaac-skill)](https://skills.sh/wundercorp/isaac-skill) | [isaac-skill](https://github.com/wundercorp/isaac-skill) | `skill-repositories/isaac-skill` |
